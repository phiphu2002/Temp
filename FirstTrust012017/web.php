...
class Vtiger_Tools_Console_ModuleController extends Vtiger_Tools_Console_Controller {
	...
	public function handle() {
		...
		$moduleInformation['name'] = 'PermissionControl';
		$moduleInformation['entityfieldlabel'] = 'companyname';
	...
	protected function create($moduleInformation) {
		...
		$field2->name = 'staffname';
		$field2->label = 'Staff Name';
		$field2->table = 'vtiger_permissioncontroldetails';
		$field2->column = $field2->staffname;
		$field2->uitype = 2;
		...
		$field3->name = 'system';
		$field3->label = 'System';
		$field3->table = 'vtiger_permissioncontroldetails';
		$field3->column = $field3->system;
		$field3->uitype = 2;
		...
		$field4->name = 'userid';
		$field4->label = 'User ID';
		$field4->table = 'vtiger_permissioncontroldetails';
		$field4->column = $field4->userid;
		$field4->uitype = 2;
		$field4->typeofdata = 'V~M';
		$block->addField($field4);

		$field5= new Vtiger_Field();
		$field5->name = 'datejoin';
		$field5->label = 'Date of Joining';
		$field5->table = 'vtiger_permissioncontroldetails';
		$field5->column = $field5->datejoin;
		$field5->uitype = 70;
		...
		$field6->name = 'dateleav';
		$field6->label = 'Date of Leaving';
		$field6->table = 'vtiger_permissioncontroldetails';
		$field6->column = $field6->dateleav;
		$field6->uitype = 70;
		...
		$field7->name = 'role';
		$field7->label = 'Role';
		$field7->table = 'vtiger_permissioncontroldetails';
		$field7->column = $field7->role;
		$field7->uitype = 2;
		...
		$field8->name = 'status';
		$field8->label = 'Status';
		$field8->table = 'vtiger_permissioncontroldetails';
		$field8->column = $field8->status;
		$field8->uitype = 2;
		$field8->typeofdata = 'V~M';
		$block->addField($field8);

		$field9 = new Vtiger_Field();
		$field9->name = 'divisions';
		$field9->label = 'Divisions';
		$field9->table = 'vtiger_permissioncontroldetails';
		$field9->column = $field9->divisions;
		$field9->uitype = 2;
		...
		$field10->name = 'note';
		$field10->label = 'Note';
		$field10->table = 'vtiger_permissioncontroldetails';
		$field10->column = $field10->note;
		$field10->uitype = 2;
		...
		$filter1->addField($field1)->addField($field2, 1)->addField($field3, 2)->addField($field4, 3)->addField($field5, 4)->addField($field6, 5)->addField($field7, 6)->addField($field8, 8)->addField($field9, 9)->addField($field10, 10);
